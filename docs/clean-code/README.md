...
> 좋은 코드는 똑똑해 보이는 코드가 아니라, 시간이 지나도 읽고 고칠 수 있는 코드입니다.
...
클린 코드는 짧은 코드가 아닙니다. 최신 문법을 많이 쓴 코드도 아닙니다.

내 기준에서 좋은 코드는 다음 질문에 답할 수 있는 코드입니다.
...
결국 좋은 코드는 유지보수 가능한 코드입니다. 유지보수 가능하다는 말은 “다음 사람이 겁먹지 않고 열어볼 수 있다”는 뜻에 가깝습니다.
