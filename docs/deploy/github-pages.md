...
> `frontend-guide` 안에 있는 정적 HTML 도구를 GitHub Pages에서 실행하는 방법을 정리합니다.
...
`code-align/index.html`처럼 폴더 안에 있는 정적 HTML도 GitHub Pages에서 실행할 수 있습니다.
...
그래서 README에는 소스 보기 링크와 실행 링크를 나눠 두는 것이 좋습니다.
