...
- [1. 기본 원칙](#1-기본-원칙)
- [2. 가장 안전한 일상 루틴](#2-가장-안전한-일상-루틴)
- [3. 브랜치 전략](#3-브랜치-전략)
- [4. 브랜치 명령어](#4-브랜치-명령어)
- [5. 커밋 메시지 규칙](#5-커밋-메시지-규칙)
- [6. 좋은 커밋 단위](#6-좋은-커밋-단위)
- [7. Pull과 Fetch 차이](#7-pull과-fetch-차이)
- [8. Merge와 Rebase](#8-merge와-rebase)
- [9. Pull Request 흐름](#9-pull-request-흐름)
- [10. Stash: 작업 중 잠시 저장하기](#10-stash-작업-중-잠시-저장하기)
- [11. Cherry-pick: 특정 커밋만 가져오기](#11-cherry-pick-특정-커밋만-가져오기)
- [12. 커밋 정리: Squash와 Fixup](#12-커밋-정리-squash와-fixup)
- [13. Amend: 방금 커밋 수정하기](#13-amend-방금-커밋-수정하기)
- [14. 원격 저장소와 upstream](#14-원격-저장소와-upstream)
- [15. 태그와 릴리스](#15-태그와-릴리스)
- [16. Fork 앱으로 작업할 때 추천 흐름](#16-fork-앱으로-작업할-때-추천-흐름)
- [17. 작업 전후 체크리스트](#17-작업-전후-체크리스트)
- [18. 추천 워크플로우 결론](#18-추천-워크플로우-결론)
