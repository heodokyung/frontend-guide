...
- [1. Git을 왜 사용할까?](#1-git을-왜-사용할까)
- [2. Git, GitHub, Fork 앱 구분하기](#2-git-github-fork-앱-구분하기)
- [3. Git의 가장 중요한 흐름](#3-git의-가장-중요한-흐름)
- [4. 처음 한 번만 하는 기본 설정](#4-처음-한-번만-하는-기본-설정)
- [5. 지금 내 상황부터 판단하기](#5-지금-내-상황부터-판단하기)
- [6. 내 폴더가 Git 저장소인지 확인하기](#6-내-폴더가-git-저장소인지-확인하기)
- [7. GitHub에 레포지토리가 아직 없는 경우](#7-github에-레포지토리가-아직-없는-경우)
- [8. GitHub 레포는 이미 있고, 로컬 폴더만 연결하려는 경우](#8-github-레포는-이미-있고-로컬-폴더만-연결하려는-경우)
- [9. GitHub에 있는 프로젝트를 새로 내려받는 경우](#9-github에-있는-프로젝트를-새로-내려받는-경우)
- [10. HTTPS와 SSH 중 무엇을 쓸까?](#10-https와-ssh-중-무엇을-쓸까)
- [11. 첫 커밋 만들기](#11-첫-커밋-만들기)
- [12. GitHub에 올리기](#12-github에-올리기)
- [13. Fork 앱을 쓸 때 기준](#13-fork-앱을-쓸-때-기준)
- [14. `.gitignore`는 왜 필요할까?](#14-gitignore는-왜-필요할까)
- [15. 입문자가 자주 하는 실수](#15-입문자가-자주-하는-실수)
- [16. 입문자용 체크리스트](#16-입문자용-체크리스트)
- [17. 핵심 결론](#17-핵심-결론)
